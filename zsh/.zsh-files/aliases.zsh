...
alias deploy_api_master='gh workflow run run_playbook.yml -f playbook=deploy_api.yml'
alias deploy_app_master='gh workflow run run_playbook.yml -f playbook=deploy_app.yml'
